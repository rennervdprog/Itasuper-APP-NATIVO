create unique index if not exists client_notifications_unique_order_status_idx
    on public.client_notifications (user_id, order_id, notification_type) nulls not distinct;
